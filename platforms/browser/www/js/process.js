let process = {
	menu:function(){
      ...
      <br/>
      <br/>
				<li><a href='#' onClick={process.page1}><img src='img/front.JPG' width='30px' /> Menu 1</a></li>
				<li><a href='#' onClick={process.page2}><img src='img/front.JPG' width='30px' /> Menu 2</a></li>
				<li><a href='#' onClick={process.page3}><img src='img/front.JPG' width='30px' /> Menu 3</a></li>
				<li><a href='#' onClick={process.page4}><img src='img/front.JPG' width='30px' /> Menu 4</a></li>
				<li><a href='#' onClick={process.page5}><img src='img/front.JPG' width='30px' /> Menu 5</a></li>
				<li><a href='#' onClick={process.page6}><img src='img/front.JPG' width='30px' /> Menu 6</a></li>
				<li><a href='#' onClick={process.page7}><img src='img/front.JPG' width='30px' /> Menu 7</a></li>
				<li><a href='#' onClick={process.page8}><img src='img/front.JPG' width='30px' /> Menu 8</a></li>
        <li><a href='#' onClick={process.page9}><img src='img/front.JPG' width='30px' /> Menu 9</a></li>
        <li><a href='#' onClick={process.page10}><img src='img/front.JPG' width='30px' /> Menu 10</a></li>
        <li><a href='#' onClick={process.page11}><img src='img/front.JPG' width='30px' /> Menu 11</a></li>
      </ul>
			</div>;
  ...
  aud1:function(){
	...
	page1:function(){
        ...
        <div className="progressbar-infinite color-multi"></div>
				<img src='img/circle.png' width='500px'/><br/>  
        <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div> 
        <br/>
				<br/>
	...
	page2:function(){
        ...
        <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
				<img src='img/heart.png' width='300px'/>
           <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
        <br/>
				<br/>
	...
	page3:function(){
        ...
        <br/>
           <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
        <img src='img/diamond.JPG' width='00px'/>
           <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
        <br/>
        <br/>
	...
	page4:function(){
        ...
        <br/>
           <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
        <img src='img/hexagon.jpg' width='300px'/>
           <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
        <br/>
        <br/>
    ...
    let content = <div>
        ...
        <br/>
           <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
        <img src='img/octagon.gif' width='300px'/><br/>   
           <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
        <br/>
        <br/>
  ...
  page6:function(){
    let content = <div>
        ...
        <br/>
           <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
        <img src='img/oval.JPG' width='300px'/>
           <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
        <br/>
        <br/>
  ...
  page7:function(){
    let content = <div>
        ...
        <br/>
           <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
        <img src='img/pentagon.JPG' width='300px'/>
           <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
        <br/>
        <br/>
  ...
  page8:function(){
      let content = <div>
        ...
        <br/>
           <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
        <img src='img/rectangle.JPG' width='300px'/>
           <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
        <br/>
        <br/>
  ...
  page9:function(){
      let content = <div>
        ...
        <br/>
           <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
        <img src='img/square.JPG' width='300px'/>
           <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
        <br/>
        <br/>
  ...
  page10:function(){
      let content = <div>
        ...
        <br/>
           <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
        <img src='img/star.png' width='300px'/>
           <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
        <br/>
        <br/>
  ...
  page11:function(){
      let content = <div>
        ...
        <br/>
           <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
        <img src='img/triangle.JPG' width='300px'/>
           <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
        <br/>
        <br/>
	...
	loading:function(){
        ...
        <div className="progressbar-infinite color-multi"></div>
					<div align='center'>
						<img src='img/front.JPG' width='300px'/>
            <div className="progressbar-infinite color-multi"></div>
               <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
					</div>;
